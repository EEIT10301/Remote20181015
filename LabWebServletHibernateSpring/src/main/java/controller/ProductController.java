...
public class ProductController {
	...
	public String method(ProductBean bean, BindingResult bindingResult, String prodaction, Model model, String id) {
//接收資料
//轉換資料
...
//驗證資料
		if ("Insert".equals(prodaction) || "Update".equals(prodaction) || "Delete".equals(prodaction)) {
			if (id == null || id.length() == 0) {
				...
				errors.put("xxx1", ctx.getMessage("product.id.required", new String[] { prodaction }, locale));
			}
		}
